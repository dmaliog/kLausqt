...
#msg_ru_RU <b>hdparm</b> — Позволяет оценить пропускную способность чтения данных с жесткого диска и его кеша, что может быть полезно при анализе и тестировании производительности хранилища данных.
