...
#msg_ru_RU <b>Unigine Sanctuary (2007)</b> — Демонстрационный бенчмарк, созданный для тестирования производительности графических систем. Он предлагает красочную 3D-среду с детализированными ландшафтами, растительностью и эффектами погоды.
