...
#msg_ru_RU <b>lsusb</b> — Отображает список всех подключенных USB-устройств и подробную информацию о каждом из них, такую как идентификатор производителя, модель устройства, серийный номер, скорость передачи данных и другую техническую информацию.
